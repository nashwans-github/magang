                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                             @forelse($instansi->bidangs as $bidang)
                                <div class="group flex flex-col items-center justify-center p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800 border border-transparent hover:border-blue-100 dark:hover:border-blue-900 shadow-sm hover:shadow-md transition">
                                    <span class="text-3xl mb-3 group-hover:scale-110 transition-transform">{{ $bidang->icon ?? '📌' }}</span>
